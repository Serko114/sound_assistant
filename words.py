...
TRIGGERS = {'кристина', 'кристину', 'кристя',
            'кресте', 'кристи', 'крестьян', 'крестясь'}

# print('fuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuckfuck')
...
data_set = {
    ...
    'запусти браузер': 'browser да господин',
